...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="./css/vendors/remixicon.css">
...
<body class="theme-color-1">
                        ...
                        <div class="main-menu">
                            <div class="menu-left">
                                ...
                                <div class="brand-logo">
                                    <a href="index.html">
                                        <img src="./images/logo.png" class="img-fluid blur-up lazyload" alt="">
                                    </a>
                                </div>
                            </div>
                                                        ...
                                                        <div class="row m-0">
                                                            ...
                                                            <div class="col-xl-4">
                                                                <a href="#!" class="mega-menu-banner">
                                                                    <img src="./images/mega-menu/fashion.jpg"
                                            ...
                                            <ul class="mega-menu full-mega-menu">
                                                <li>
                                                    <div class="container">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-12">
                                                                <img src="./images/menu-banner.jpg" alt=""
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="counter-box">
                                            <img src="./images/balance.png" alt="" class="img-fluid">
                                            <div>
                                                <h3>$12.46</h3>
                                                <h5>Total Order</h5>
                                            </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="counter-box">
                                            <img src="./images/points.png" alt="" class="img-fluid">
                                            <div>
                                                <h3>2530</h3>
                                                <h5>Total Points</h5>
                                            </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="counter-box">
                                            <img src="./images/order.png" alt="" class="img-fluid">
                                            <div>
                                                <h3>15</h3>
                                                <h5>Total Orders</h5>
                                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-6 col-md-6 col-sm-12">
                        <div class="payment-card-bottom">
                            <img alt="payment options" src="./images/payment.png" class="img-fluid">
                        </div>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="overflow-hidden">
                                        <div class="img-wrapper">
                                            ...
                                            <a href="product-page(accordian).html">
                                                <img src="./images/fashion-1/product/1.jpg"
                            ...
                            <div class="col">
                                <div class="basic-product theme-product-1">
                                    <div class="overflow-hidden">
                                        <div class="img-wrapper">
                                            <a href="product-page(accordian).html">
                                                <img src="./images/fashion-1/product/16.jpg"
                                                    class="img-fluid blur-up lazyloaded" alt="">
                                            </a>
                                            <div class="rating-label"><i class="fa fa-star"></i>
                                                <span>8.7</span>
            ...
            <div class="cart-media">
                <ul class="cart-product">
                    <li>
                        <div class="media">
                            <a href="#!">
                                <img src="./images/fashion-1/product/5.jpg" class="img-fluid"
                                    alt="Classic Jacket">
                            </a>
                    ...
                    <li>
                        <div class="media">
                            <a href="#!">
                                <img src="./images/fashion-1/product/13.jpg" class="img-fluid"
                                    alt="Classic Jacket">
                            </a>
                            <div class="media-body">
                                <a href="#!">
                    ...
                    <li>
                        <div class="media">
                            <a href="#!">
                                <img src="./images/fashion-1/product/12.jpg" class="img-fluid"
                                    alt="Classic Jacket">
                            </a>
                            <div class="media-body">
                                <a href="#!">
                                            ...
                                            <div class="col-md-6 col-6 text-center demo-effects">
                                                <div class="set-position">
                                                    <a href="index.html" class="layout-container">
                                                        <img src="./images/custemizer/demo/fashion-1.png"
                                                            class="img-fluid" alt="">
                                                    </a>
                                            ...
                                            <div class="col-md-6 col-6 text-center demo-effects">
                                                <div class="set-position">
                                                    <a href="fashion-2.html" class="layout-container">
                                                        <img src="./images/custemizer/demo/fashion-2.png"
                                                            class="img-fluid" alt="">
                                                    </a>
                                                    <a href="fashion-2.html" class="demo-text">
                                                        <span>fashion 2</span>
                                            ...
                                            <div class="col-md-6 col-6 text-center demo-effects">
                                                <div class="set-position">
                                                    <a href="fashion-3.html" class="layout-container">
                                                        <img src="./images/custemizer/demo/fashion-3.png"
                                                            class="img-fluid" alt="">
                                                    </a>
                                            ...
                                            <div class="col-md-6 col-6 text-center demo-effects">
                                                <div class="set-position">
                                                    <a href="fashion-4.html" class="layout-container">
                                                        <img src="./images/custemizer/demo/fashion-4.png"
                                                            class="img-fluid" alt="">
                                                    </a>
                                            ...
                                            <div class="col-md-6 col-6 text-center demo-effects">
                                                <div class="set-position">
                                                    <a href="fashion-5.html" class="layout-container">
                                                        <img src="./images/custemizer/demo/fashion-5.png"
                                                            class="img-fluid" alt="">
                                                    </a>
                                            ...
                                            <div class="col-md-6 col-6 text-center demo-effects">
                                                <div class="set-position">
                                                    <a href="fashion-6.html" class="layout-container">
                                                        <img src="./images/custemizer/demo/fashion-6.png"
                                                            class="img-fluid" alt="">
                                                    </a>
                                            ...
                                            <div class="col-md-6 col-6 text-center demo-effects">
                                                <div class="set-position">
                                                    <a href="fashion-7.html" class="layout-container">
                                                        <img src="./images/custemizer/demo/fashion-7.png"
                                                            class="img-fluid" alt="">
                                                    </a>
                                            ...
                                            <div class="col-md-6 col-6 text-center demo-effects">
                                                <div class="set-position">
                                                    <a href="furniture.html" class="layout-container">
                                                        <img src="./images/custemizer/demo/furniture-1.png"
                                                            class="img-fluid" alt="">
                                                    </a>
                                            ...
                                            <div class="col-md-6 col-6 text-center demo-effects">
                                                <div class="set-position">
                                                    <a href="furniture-2.html" class="layout-container">
                                                        <img src="./images/custemizer/demo/furniture-2.png"
                                                            class="img-fluid" alt="">
                                                    </a>
                                            ...
                                            <div class="col-md-6 col-6 text-center demo-effects">
                                                <div class="set-position">
                                                    <a href="furniture-3.html" class="layout-container">
                                                        <img src="./images/custemizer/demo/furniture-dark.png"
                                                            class="img-fluid" alt="">
                                                    </a>
                                            ...
                                            <div class="col-md-6 col-6 text-center demo-effects">
                                                <div class="set-position">
                                                    <a href="electronic-1.html" class="layout-container">
                                                        <img src="./images/custemizer/demo/electronic-1.png"
                                                            class="img-fluid" alt="">
                                                    </a>
                                            ...
                                            <div class="col-md-6 col-6 text-center demo-effects">
                                                <div class="set-position">
                                                    <a href="electronic-2.html" class="layout-container">
                                                        <img src="./images/custemizer/demo/electronic-2.png"
                                                            class="img-fluid" alt="">
                                                    </a>
                                            ...
                                            <div class="col-md-6 col-6 text-center demo-effects">
                                                <div class="set-position">
                                                    <a href="electronic-3.html" class="layout-container">
                                                        <img src="./images/custemizer/demo/electronic-3.png"
                                                            class="img-fluid" alt="">
                                                    </a>
                                            ...
                                            <div class="col-md-6 col-6 text-center demo-effects">
                                                <div class="set-position">
                                                    <a href="marketplace-demo.html" class="layout-container">
                                                        <img src="./images/custemizer/demo/marketplace-1.png"
                                                            class="img-fluid" alt="">
                                                    </a>
                                            ...
                                            <div class="col-md-6 col-6 text-center demo-effects">
                                                <div class="set-position">
                                                    <a href="marketplace-demo-2.html" class="layout-container">
                                                        <img src="./images/custemizer/demo/marketplace-2.png"
                                                            class="img-fluid" alt="">
                                                    </a>
                                            ...
                                            <div class="col-md-6 col-6 text-center demo-effects">
                                                <div class="set-position">
                                                    <a href="marketplace-demo-3.html" class="layout-container">
                                                        <img src="./images/custemizer/demo/marketplace-3.png"
                                                            class="img-fluid" alt="">
                                                    </a>
                                            ...
                                            <div class="col-md-6 col-6 text-center demo-effects">
                                                <div class="set-position">
                                                    <a href="marketplace-demo-4.html" class="layout-container">
                                                        <img src="./images/custemizer/demo/marketplace-4.png"
                                                            class="img-fluid" alt="">
                                                    </a>
                                            ...
                                            <div class="col-md-6 col-6 text-center demo-effects">
                                                <div class="set-position">
                                                    <a href="vegetables.html" class="layout-container">
                                                        <img src="./images/custemizer/demo/vegetable-1.png"
                                                            class="img-fluid" alt="">
                                                    </a>
                                            ...
                                            <div class="col-md-6 col-6 text-center demo-effects">
                                                <div class="set-position">
                                                    <a href="vegetables-2.html" class="layout-container">
                                                        <img src="./images/custemizer/demo/vegetable-2.png"
                                                            class="img-fluid" alt="">
                                                    </a>
                                            ...
                                            <div class="col-md-6 col-6 text-center demo-effects">
                                                <div class="set-position">
                                                    <a href="vegetables-3.html" class="layout-container">
                                                        <img src="./images/custemizer/demo/vegetable-3.png"
                                                            class="img-fluid" alt="">
                                                    </a>
                                            ...
                                            <div class="col-md-6 col-6 text-center demo-effects">
                                                <div class="set-position">
                                                    <a href="vegetables-4.html" class="layout-container">
                                                        <img src="./images/custemizer/demo/vegetable-4.png"
                                                            class="img-fluid" alt="">
                                                    </a>
                                            ...
                                            <div class="col-md-6 col-6 text-center demo-effects">
                                                <div class="set-position">
                                                    <a href="vegetables-5.html" class="layout-container">
                                                        <img src="./images/custemizer/demo/vegetable-5.png"
                                                            class="img-fluid" alt="">
                                                    </a>
                                            ...
                                            <div class="col-md-6 col-6 text-center demo-effects">
                                                <div class="set-position">
                                                    <a href="jewellery.html" class="layout-container">
                                                        <img src="./images/custemizer/demo/jewellery-1.png"
                                                            class="img-fluid" alt="">
                                                    </a>
                                            ...
                                            <div class="col-md-6 col-6 text-center demo-effects">
                                                <div class="set-position">
                                                    <a href="jewellery-2.html" class="layout-container">
                                                        <img src="./images/custemizer/demo/jewellery-2.png"
                                                            class="img-fluid" alt="">
                                                    </a>
                                            ...
                                            <div class="col-md-6 col-6 text-center demo-effects">
                                                <div class="set-position">
                                                    <a href="jewellery-3.html" class="layout-container">
                                                        <img src="./images/custemizer/demo/jewellery-3.png"
                                                            class="img-fluid" alt="">
                                                    </a>
                                            ...
                                            <div class="col-md-6 col-6 text-center demo-effects">
                                                <div class="set-position">
                                                    <a href="bags.html" class="layout-container">
                                                        <img src="./images/custemizer/demo/bag.png"
                                                            class="img-fluid" alt="">
                                                    </a>
                                            ...
                                            <div class="col-md-6 col-6 text-center demo-effects">
                                                <div class="set-position">
                                                    <a href="watch.html" class="layout-container">
                                                        <img src="./images/custemizer/demo/watch.png"
                                                            class="img-fluid" alt="">
                                                    </a>
                                            ...
                                            <div class="col-md-6 col-6 text-center demo-effects">
                                                <div class="set-position">
                                                    <a href="medical.html" class="layout-container">
                                                        <img src="./images/custemizer/demo/medical.png"
                                                            class="img-fluid" alt="">
                                                    </a>
                                            ...
                                            <div class="col-md-6 col-6 text-center demo-effects">
                                                <div class="set-position">
                                                    <a href="perfume.html" class="layout-container">
                                                        <img src="./images/custemizer/demo/perfume.png"
                                                            class="img-fluid" alt="">
                                                    </a>
                                            ...
                                            <div class="col-md-6 col-6 text-center demo-effects">
                                                <div class="set-position">
                                                    <a href="yoga.html" class="layout-container">
                                                        <img src="./images/custemizer/demo/yoga.png"
                                                            class="img-fluid" alt="">
                                                    </a>
                                            ...
                                            <div class="col-md-6 col-6 text-center demo-effects">
                                                <div class="set-position">
                                                    <a href="christmas.html" class="layout-container">
                                                        <img src="./images/custemizer/demo/christmas.png"
                                                            class="img-fluid" alt="">
                                                    </a>
                                            ...
                                            <div class="col-md-6 col-6 text-center demo-effects">
                                                <div class="set-position">
                                                    <a href="bicycle.html" class="layout-container">
                                                        <img src="./images/custemizer/demo/bicycle.png"
                                                            class="img-fluid" alt="">
                                                    </a>
                                            ...
                                            <div class="col-md-6 col-6 text-center demo-effects">
                                                <div class="set-position">
                                                    <a href="marijuana.html" class="layout-container">
                                                        <img src="./images/custemizer/demo/marijuna.png"
                                                            class="img-fluid" alt="">
                                                    </a>
                                            ...
                                            <div class="col-md-6 col-6 text-center demo-effects">
                                                <div class="set-position">
                                                    <a href="gym-product.html" class="layout-container">
                                                        <img src="./images/custemizer/demo/gym.png"
                                                            class="img-fluid" alt="">
                                                    </a>
                                            ...
                                            <div class="col-md-6 col-6 text-center demo-effects">
                                                <div class="set-position">
                                                    <a href="tools.html" class="layout-container">
                                                        <img src="./images/custemizer/demo/tools.png"
                                                            class="img-fluid" alt="">
                                                    </a>
                                            ...
                                            <div class="col-md-6 col-6 text-center demo-effects">
                                                <div class="set-position">
                                                    <a href="shoes.html" class="layout-container">
                                                        <img src="./images/custemizer/demo/shoes.png"
                                                            class="img-fluid" alt="">
                                                    </a>
                                            ...
                                            <div class="col-md-6 col-6 text-center demo-effects">
                                                <div class="set-position">
                                                    <a href="books.html" class="layout-container">
                                                        <img src="./images/custemizer/demo/books.png"
                                                            class="img-fluid" alt="">
                                                    </a>
                                            ...
                                            <div class="col-md-6 col-6 text-center demo-effects">
                                                <div class="set-position">
                                                    <a href="kids.html" class="layout-container">
                                                        <img src="./images/custemizer/demo/kids.png"
                                                            class="img-fluid" alt="">
                                                    </a>
                                            ...
                                            <div class="col-md-6 col-6 text-center demo-effects">
                                                <div class="set-position">
                                                    <a href="game.html" class="layout-container">
                                                        <img src="./images/custemizer/demo/games.png"
                                                            class="img-fluid" alt="">
                                                    </a>
                                            ...
                                            <div class="col-md-6 col-6 text-center demo-effects">
                                                <div class="set-position">
                                                    <a href="beauty.html" class="layout-container">
                                                        <img src="./images/custemizer/demo/beauty.png"
                                                            class="img-fluid" alt="">
                                                    </a>
                                            ...
                                            <div class="col-md-6 col-6 text-center demo-effects">
                                                <div class="set-position">
                                                    <a href="left_sidebar-demo.html" class="layout-container">
                                                        <img src="./images/custemizer/demo/left-sidebar.png"
                                                            class="img-fluid" alt="">
                                                    </a>
                                            ...
                                            <div class="col-md-6 col-6 text-center demo-effects">
                                                <div class="set-position">
                                                    <a href="video-slider.html" class="layout-container">
                                                        <img src="./images/custemizer/demo/video_slider.png"
                                                            class="img-fluid" alt="">
                                                    </a>
                                            ...
                                            <div class="col-md-6 col-6 text-center demo-effects">
                                                <div class="set-position">
                                                    <a href="metro.html" class="layout-container">
                                                        <img src="./images/custemizer/demo/metro.png"
                                                            class="img-fluid" alt="">
                                                    </a>
                                            ...
                                            <div class="col-md-6 col-6 text-center demo-effects">
                                                <div class="set-position">
                                                    <a href="goggles.html" class="layout-container">
                                                        <img src="./images/custemizer/demo/goggles.png"
                                                            class="img-fluid" alt="">
                                                    </a>
                                            ...
                                            <div class="col-md-6 col-6 text-center demo-effects">
                                                <div class="set-position">
                                                    <a href="flower.html" class="layout-container">
                                                        <img src="./images/custemizer/demo/flowers.png"
                                                            class="img-fluid" alt="">
                                                    </a>
                                            ...
                                            <div class="col-md-6 col-6 text-center demo-effects">
                                                <div class="set-position">
                                                    <a href="light.html" class="layout-container">
                                                        <img src="./images/custemizer/demo/light.png"
                                                            class="img-fluid" alt="">
                                                    </a>
                                            ...
                                            <div class="col-md-6 col-6 text-center demo-effects">
                                                <div class="set-position">
                                                    <a href="nursery.html" class="layout-container">
                                                        <img src="./images/custemizer/demo/nursery.png"
                                                            class="img-fluid" alt="">
                                                    </a>
                                            ...
                                            <div class="col-md-6 col-6 text-center demo-effects">
                                                <div class="set-position">
                                                    <a href="pets.html" class="layout-container">
                                                        <img src="./images/custemizer/demo/pets.png"
                                                            class="img-fluid" alt="">
                                                    </a>
                                            ...
                                            <div class="col-md-6 col-6 text-center demo-effects">
                                                <div class="set-position">
                                                    <a href="video.html" class="layout-container">
                                                        <img src="./images/custemizer/demo/video.png"
                                                            class="img-fluid" alt="">
                                                    </a>
                                            ...
                                            <div class="col-md-6 col-6 text-center demo-effects">
                                                <div class="set-position">
                                                    <a href="gradient.html" class="layout-container">
                                                        <img src="./images/custemizer/demo/gradient.png"
                                                            class="img-fluid" alt="">
                                                    </a>
                                            ...
                                            <div class="col-md-6 col-6 text-center demo-effects">
                                                <div class="set-position">
                                                    <a href="lookbook-demo.html" class="layout-container">
                                                        <img src="./images/custemizer/demo/lookbook.png"
                                                            class="img-fluid" alt="">
                                                    </a>
                                            ...
                                            <div class="col-md-6 col-6 text-center demo-effects">
                                                <div class="set-position">
                                                    <a href="full-page.html" class="layout-container">
                                                        <img src="./images/custemizer/demo/full_page.png"
                                                            class="img-fluid" alt="">
                                                    </a>
                                            ...
                                            <div class="col-md-6 col-6 text-center demo-effects">
                                                <div class="set-position">
                                                    <a href="parallax.html" class="layout-container">
                                                        <img src="./images/custemizer/demo/parallax.png"
                                                            class="img-fluid" alt="">
                                                    </a>
                                            ...
                                            <div class="col-md-6 col-6 text-center demo-effects">
                                                <div class="set-position">
                                                    <a href="nft.html" class="layout-container">
                                                        <img src="./images/custemizer/demo/nft.png"
                                                            class="img-fluid" alt="">
                                                    </a>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row g-3">
                        <div class="col-xxl-12">
                            <div class="form-box">
                                ...
                                <input id="name" type="text" value="john due" class="form-control"
                        ...
                        <div class="col-xxl-12">
                            <div class="form-box">
                                ...
                                <input id="name1" type="email" value="john.customer@example.com" class="form-control"
                                    placeholder="Enter Email">
                            </div>
                        </div>
                        <div class="col-xxl-12">
                            <div class="form-box">
                                <label for="name2" class="form-label">Phone Number</label>
                                <input id="name2" type="tel" value="(+1) 65558845" class="form-control"
                    ...
                    <div class="mt-3 d-flex align-items-center justify-content-end gap-2">
                        ...
                        <button class="btn btn-solid" type="submit" data-bs-dismiss="modal">
                            Submit
                        </button>
                    </div>
                </div>
    ...
    <div class="modal fade theme-modal-2" id="edit-password" tabindex="-1">
        <div class=" modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="fw-semibold">Edit Password</h3>
                    <button class="btn btn-close" type="submit" data-bs-dismiss="modal">
                        <i class="ri-close-line"></i>
                    </button>
                </div>
                <div class="modal-body">
                    <div class="row g-3">
                        ...
                        <div class="col-xxl-12">
                            <div class="form-box">
                                ...
                                <input id="New" type="password" class="form-control" placeholder="Enter New Password">
                            </div>
                        </div>
                        <div class="col-xxl-12">
                            <div class="form-box">
                    ...
                    <div class="mt-3 d-flex align-items-center justify-content-end gap-2">
                        ...
                        <button class="btn btn-solid" id="submit_profile_btn1" type="submit" data-bs-dismiss="modal">
                            Submit
                        </button>
                    </div>
                </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row g-3">
                        ...
                        <div class="col-xxl-12">
                            <div class="form-box">
                                <label for="name32" class="form-label">Address</label>
                                <input id="name32" type="text" class="form-control" placeholder="Enter Address">
                            </div>
                        </div>
                        <div class="col-xxl-12">
                            <div class="form-box">
                                <label for="name4" class="form-label">Phone Number</label>
                                <input id="name4" type="tel" value="(+1) 65558845" class="form-control"
                                    placeholder="Enter Phone Number">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6">
                            <div class="form-box">
                                ...
                                <select class="form-control form-select quantity-variant select-dropdown"
                                    id="input-state-02">
                                    <option selected="" disabled>Select Country </option>
                                    <option value="0" class=""> United States </option>
                                    <option value="1" class=""> United Kingdom </option>
                                    <option value="2" class=""> India </option>
                                    <option value="3" class=""> Canada </option>
                                </select>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-box">
                                ...
                                <select class="form-control form-select quantity-variant select-dropdown"
                                    id="input-state-04">
                                    <option selected="" disabled>Select Country </option>
                                    <option value="0" class=""> New York </option>
                                    <option value="1" class=""> London </option>
                                    <option value="2" class=""> Delhi </option>
                                    <option value="3" class=""> Ottawa </option>
                                </select>
                            </div>
                        </div>
                        <div class="col-lg-6">
                        ...
                        <div class="col-lg-6">
                            <div class="form-box">
                                ...
                                <input id="pincode" type="number" class="form-control" placeholder="Enter Pin Code">
                            </div>
                        </div>
                    </div>
                    <div class="mt-3 d-flex align-items-center justify-content-end gap-2">
                ...
                <div class="modal-body">
                    <div class="row g-3">
                        <div class="col-xxl-12">
                            <div class="form-box">
                                <label for="title" class="form-label"> title</label>
                                <input id="title2" type="text" value="Home" class="form-control"
                                    placeholder="Enter title">
                            </div>
                        </div>
                        <div class="col-xxl-12">
                            <div class="form-box">
                                <label for="name6" class="form-label">Address</label>
                                <input id="name6" type="text" value="26, Starts Hollow Colony" class="form-control"
                                    placeholder="Enter Address">
                            </div>
                        </div>
                        <div class="col-xxl-12">
                            <div class="form-box">
                                <label for="name5" class="form-label">Phone Number</label>
                                <input id="name5" type="tel" value="(+1) 65558845" class="form-control"
                                    placeholder="Enter Phone Number">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6">
                            <div class="form-box">
                                ...
                                <select class="form-control form-select quantity-variant select-dropdown"
                                    ...
                                    <option selected="" value="0" class=""> United States </option>
                                    <option value="1" class=""> United Kingdom </option>
                                    <option value="2" class=""> India </option>
                                    <option value="3" class=""> Canada </option>
                                </select>
                        ...
                        <div class="col-lg-6">
                            <div class="form-box">
                                ...
                                <select class="form-control form-select quantity-variant select-dropdown"
                                    id="input-state-0">
                                    <option disabled>Select Country </option>
                                    <option selected="" value="0" class=""> New York </option>
                                    <option value="1" class=""> London </option>
                                    <option value="2" class=""> Delhi </option>
                                    <option value="3" class=""> Ottawa </option>
                                </select>
                        ...
                        <div class="col-lg-6">
                            <div class="form-box">
                                ...
                                <input id="city2" type="text" class="form-control" value="Albany"
                                    placeholder="Enter City">
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-box">
                                <label for="pincode2" class="form-label">Pin Code</label>
                                <input id="pincode2" type="number" class="form-control" value="12204"
                    ...
                    <div class="mt-3 d-flex align-items-center justify-content-end gap-2">
                        <button class="btn btn-md btn-outline fw-bold" data-bs-dismiss="modal">Cancel</button>
                        <button class="btn btn-solid" data-bs-dismiss="modal">Submit</button>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="modal-body p-3">
                    <div class="trash-box text-center">
                        ...
                        <div class="mt-3 d-flex align-items-center justify-content-center gap-2">
                            ...
                            <button class="btn btn-solid" data-bs-dismiss="modal">Yes</button>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!-- logout starts -->
    <div class="modal fade theme-modal-2 exit-modal" id="logout" data-bs-backdrop="static" tabindex="-1">
        <div class=" modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-body p-3">
                    ...
                    <div class="mt-3 d-flex align-items-center justify-content-center gap-2">
                        <button class="btn btn-md btn-outline fw-bold" data-bs-dismiss="modal">No</button>
                        <a href="index.html" class="btn btn-solid">Yes</a>
                    </div>
                </div>
            </div>
        </div>
