...
async function initMap() {
  ...
  const position_1 = { lat: 51.498265, lng: -0.13105 };
  ...
  if (store_selector_1) {
    store_selector_1.addEventListener(
      "click",
      function (e) {
        ...
        document.querySelector(
          ".google-map__marker-detail__content"
        ).innerHTML = store_selector_1.closest(
  ...
  if (store_selector_2) {
    store_selector_2.addEventListener(
      "click",
      function (e) {
        store_info.classList.remove("hide");
        ...
        document.querySelector(
          ".google-map__marker-detail__content"
        ).innerHTML = store_selector_2.closest(
          ".store-location__search-result__item"
        ).innerHTML;
      },
      false
  ...
  if (store_selector_3) {
    store_selector_3.addEventListener(
      "click",
      function (e) {
        store_info.classList.remove("hide");
        ...
        document.querySelector(
          ".google-map__marker-detail__content"
        ).innerHTML = store_selector_3.closest(
          ".store-location__search-result__item"
        ).innerHTML;
      },
      false
  ...
  let store_info_close_btn = document.querySelector(
    ".google-map__marker-detail .btn-close"
  );
  if (store_info_close_btn && store_info) {
    store_info_close_btn.addEventListener(
      "click",
      function (e) {
